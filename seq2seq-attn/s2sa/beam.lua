...
cmd:option('-src_dict', 'data/twit/twit.src.dict', [[Path to source vocabulary (*.src.dict file)]])
cmd:option('-targ_dict', 'data/twit/twit.targ.dict', [[Path to target vocabulary (*.targ.dict file)]])
cmd:option('-feature_dict_prefix', 'data/twit/twit', [[Prefix of the path to features vocabularies (*.feature_N.dict files)]])
cmd:option('-char_dict', 'data/twit/twit.char.dict', [[If using chars, path to character vocabulary (*.char.dict file)]])
